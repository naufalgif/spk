...
<head>
  ...
  <title>WeCare | Registration</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="{{asset('admintem')}}/index2.html"><b>WeCare</b>Registration</a>
  </div>
  <!-- /.login-logo -->
...
<!-- iCheck -->
<script src="{{asset('admintem')}}/plugins/iCheck/icheck.min.js"></script>
<script>
  $(function () {
    $('input').iCheck({
